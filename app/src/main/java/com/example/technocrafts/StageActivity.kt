...
val text1 = "Your company is spending more money on infrastructure than needed .  "
tv1.text = text1
    }
    else if (input2!!.toInt() < 105600 && input2!!.toInt() > 10 ){
        val text1 = "Your company is spending Right amount of money need for expansion infrastructure than needed .  "
        tv1.text = text1
    }
    else if(input2!!.toInt() < 10){
        val text1 = "Your company needs to spend more money on infrastructure if you want to Grow . "
        tv1.text = text1
    }
